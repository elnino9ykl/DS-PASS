...
class _BNReluConv(nn.Sequential):
    def __init__(self, num_maps_in, num_maps_out, k=3, batch_norm=True, bn_momentum=0.1, bias=False, dilation=1, use_sppad=False, split=1):
        ...
        padding = k // 2
        self.add_module('conv', spConv2d(num_maps_in, num_maps_out,
                                          kernel_size=k, padding=padding, bias=bias, dilation=dilation, use_sppad=use_sppad, split=split))
