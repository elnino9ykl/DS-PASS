...
def conv3x3(in_planes, out_planes, stride=1, use_sppad=False, split=1):
    ...
    return spConv2d(in_planes, out_planes, kernel_size=3, stride=stride,
                     padding=1, bias=False, use_sppad=use_sppad, split=split)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, efficient=True, use_bn=True, use_sppad=False, split=1):
...
class ResNet(nn.Module):
    def __init__(self, block, layers, *, num_features=128, k_up=3, efficient=True, use_bn=True,
                 spp_grids=(8, 4, 2, 1), spp_square_grid=False, use_sppad=False, split=1, **kwargs):
        ...
        self.efficient = efficient
        self.use_bn = use_bn
        self.conv1 = spConv2d(3, 64, kernel_size=7, stride=2, padding=3,
                               bias=False, use_sppad=use_sppad, split=split)
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        layers = [block(self.inplanes, planes, stride, downsample, efficient=self.efficient, use_bn=self.use_bn, use_sppad=self.use_sppad, split=self.split)]
        self.inplanes = planes * block.expansion
        for i in range(1, blocks):
            layers += [block(self.inplanes, planes, efficient=self.efficient, use_bn=self.use_bn, use_sppad=self.use_sppad, split=self.split)]
